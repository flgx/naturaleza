...
"alpha_num_spaces"  => "El campo :attribute sólo puede contener letras, números y espacios.",
"double"            => "El campo :attribute debe ser del tipo flotante.",
"code"              => "El campo :attribute sólo puede contener letras, números y los caracteres  (/, -, .)",
"file_extension"    => "Sólo se debe importar archivos de tipo :values.",
"phone"             => "El campo :attribute debe ser del tipo teléfono.",
/*
|--------------------------------------------------------------------------
...
'attributes' => array(
    ...
    'image'             => 'imagen',
    'currency'          => 'moneda',
    'from_date_at'      => 'vigencia',
    'currency_id'       => 'moneda',
    'measure_id'        => 'medida',
    'container_id'		=> 'embalaje',
    'packaging_qty'     => 'cantidad de envases',
    'measure_qty'       => 'cantidad',
    'market'            => 'mercado',
    'market_id'         => 'mercado',
